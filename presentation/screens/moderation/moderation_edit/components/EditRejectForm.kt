package com.itirafapp.android.presentation.screens.moderation.moderation_edit.components
...
import com.itirafapp.android.presentation.screens.moderation.moderation_edit.ModerationEditEvent
import com.itirafapp.android.presentation.screens.moderation.moderation_edit.ModerationEditState
...
fun EditRejectForm(
    ...
    ExposedDropdownMenuBox(
        ...
        onExpandedChange = { onEvent(ModerationEditEvent.ToggleViolationDropdown) },
        ...
        ExposedDropdownMenu(
            expanded = state.isViolationDropdownExpanded,
            onDismissRequest = { onEvent(ModerationEditEvent.DismissViolationDropdown) }
        ) {
            state.availableViolations.forEach { violation ->
                ...
                DropdownMenuItem(
                    ...
                    onClick = {
                        onEvent(ModerationEditEvent.ToggleViolation(violation))
                    },
    ...
    OutlinedTextField(
        ...
        onValueChange = { onEvent(ModerationEditEvent.EnteredRejectionReason(it)) },
        modifier = Modifier.fillMaxWidth(),
        minLines = 2,
